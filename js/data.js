const PLATFORM_DATA = {
  ...
  filters: {
    majorDevelopment: ['All Major Developments', 'Legacy Terminals', 'Terminal Beta', 'Terminal Alpha', 'Gateway Terminal', 'Cargo Hub', 'Private Aviation'],
    projectArea: ['All Areas', 'North Zone', 'South Zone', 'East Zone', 'West Zone', 'Central Zone'],
    ...
    externalEntity: ['All Entities', 'MDA', 'RWA', 'WSA', 'NPC', 'CTA', 'MoT'],
  ...
  milestones: [
    { date: 'Q2 2026', asset: 'Cargo Hub', status: 'Ready' },
    ...
    { date: 'Q4 2027', asset: 'Legacy Terminals', status: 'At Risk' },
    { date: 'Q3 2028', asset: 'Terminal Alpha', status: 'At Risk' },
    { date: 'Q1 2029', asset: 'Terminal Beta', status: 'Conditional' },
    { date: 'Q4 2038', asset: 'Gateway Terminal', status: 'At Risk' }
  ],
  ...
  committeeActions: [
    ...
    { action: 'RWA commitment confirmation for booster station BS-07', severity: 'High', due: '01 Mar 2026', status: 'Pending' }
  ],
  ...
  entityPerformance: [
    { entity: 'MDA', projects: 8, onTrack: 4, atRisk: 2, delayed: 2 },
    { entity: 'RWA', projects: 6, onTrack: 3, atRisk: 2, delayed: 1 },
    { entity: 'NPC', projects: 5, onTrack: 3, atRisk: 1, delayed: 1 },
    { entity: 'WSA', projects: 4, onTrack: 2, atRisk: 1, delayed: 1 },
    { entity: 'CTA', projects: 3, onTrack: 1, atRisk: 1, delayed: 1 },
    { entity: 'MoT', projects: 4, onTrack: 3, atRisk: 1, delayed: 0 }
  ],

  // Module cards (LP-07, LP-08)
  modules: [
    { number: 1, title: 'Master Plan Readiness Cockpit', description: 'Assess whether platform assets and milestones are enabled by the required infrastructure services.', icon: '📊', href: '#' },
    { number: 2, title: 'Scenario Planning', description: 'Compare alternative infrastructure, growth, funding and delivery scenarios and their effects on readiness.', icon: '🔄', href: 'scenario-planning.html' },
    { number: 3, title: 'Supply, Demand & Gap Management', description: 'Determine whether sufficient infrastructure supply will be available when each project asset requires it.', icon: '📈', href: 'supply-demand.html' },
    ...
    { number: 6, title: 'Land, Corridors, Approvals & Prerequisites', description: 'Monitor non-construction prerequisites that enable infrastructure projects and project connections.', icon: '🗺️' },
    { number: 7, title: 'Integrated Dependencies & Critical Path', description: 'Show the complete critical path from enabling infrastructure to every project asset milestone.', icon: '🔗' },
